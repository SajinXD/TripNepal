  ...
  return (
    <SafeScreen edges={['top', 'bottom']} bg="#F7F7F4">
      <View className="flex-1 items-center justify-center px-6">
        ...
        <Text className="font-display text-3xl text-text text-center mb-3">License Under Review</Text>
        <Text className="font-sans text-base text-text-secondary text-center mb-8">
          Your NTB license has been submitted. Our team will verify it within 1–2 business days.
        </Text>
        ...
        <View className="bg-white rounded-2xl p-5 w-full border border-border shadow-sm mb-8">
          ...
          <Text className="text-sm text-text-secondary">
            We will notify you once your license has been verified.
          </Text>
        </View>

        <Button onPress={() => router.replace('/(guide)/dashboard' as any)} fullWidth variant="outline">
          Go to Dashboard
        </Button>
      </View>
    </SafeScreen>
