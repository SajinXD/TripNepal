...
export default function WelcomeScreen() {
	...
	return (
		<View className="flex-1 bg-surface">
			...
			<ImageBackground
				source={{
					uri: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000&auto=format&fit=crop",
				}}
			...
			>
				...
				<View
					...
					className="px-6 flex-row justify-between items-start"
				>
					<View>
						<Text className="text-white/70 font-bodyBold text-[12px] uppercase tracking-wider mb-1">
							HIGHLANDS & HORIZONS
						</Text>
						<Text className="font-displayBold text-[24px] text-white">
							Trip Nepal
						</Text>
					</View>
				</View>
				...
				>
					<View className="bg-white/20 border border-white/20 self-start px-3 py-1.5 rounded-[8px] flex-row items-center mb-6">
						...
						<Text className="text-white font-bodyBold text-[12px] ml-1.5 tracking-wider uppercase">
					...
					<Text className="text-white font-body text-[16px] leading-[24px] mb-8 pr-4">
						Navigate the rugged beauty of the Himalayas with
						expert-led expeditions and real-time mountain
						intelligence.
					</Text>
					...
					<View className="flex-row items-center justify-between border-t border-white/20 pt-6">
						<View>
							<Text className="text-white font-displaySemiBold text-[20px]">
								8,848m
							</Text>
							<Text className="text-white/70 font-bodyMedium text-[11px] uppercase tracking-wider">
								MAX ELEVATION
							</Text>
						</View>
						<View>
